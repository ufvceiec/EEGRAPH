...
class TestImportData(unittest.TestCase):
    ...
    def test_load_data(self):
        path = 'Test_files/chb02_16.edf'                               #Public EEG dataset. https://physionet.org/content/chbmit/1.0.0/
        channels = 23
    ...
    def test_load_data_electrode_montage(self):
        path = 'Test_files/test_eeg.gdf'                               
        electrode_montage_path = "Test_files/electrodemontage.set.ced"
